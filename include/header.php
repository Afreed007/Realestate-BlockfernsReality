<header id="header" class="transparent-header-modern fixed-header-bg-white w-100">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <ul class="top-contact list-text-white  d-table">
                                <li><a href="#"><i class=" text-success mr-1"></i>BlockFernsReality</a></li>
                        ...
                        <div class="col-md-4">
                            <div class="top-contact float-right">
                                ...
                                <li>|</li> 
                                <li><i class="fas fa-user text-success mr-1"></i><a href="admin/index.php">Administrator</li>
								</ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="main-nav secondary-nav hover-success-nav py-2">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <nav class="navbar navbar-expand-lg navbar-light p-0"> <a class="navbar-brand position-relative" href="index.php"><img class="nav-logo" src="images/logo/blockfernslogo.jpg" alt=""></a>
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    <ul class="navbar-nav mr-auto">
                                        ...
                                        <li class="nav-item"> <a class="nav-link" href="admin/index.php">Administrator</a> </li>
										<?php } ?>
